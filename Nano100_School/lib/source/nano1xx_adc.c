...
/**
  ...
  * @param  u32InputMode Specify the input mode, valid values are ADC_CR_ADMD_SINGEL, ADC_CR_ADMD_S_CYCLE, and ADC_CR_ADMD_CONTINUOUS
  * @param  u32OpMode Specify the operation mode, valid values are ADC_CR_DIFF and ADC_CR_SINGLE_END
...
/**
  ...
  * @param  mode Calibration mode. Could be ADC_CALCTL_CALSEL or ADC_CALCTL_LOAD
  * @return None
  */
