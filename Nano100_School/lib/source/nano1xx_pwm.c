...
/**
  ...
  * @param  u8Capture Specity the channel to be configured
  * @param  enable Enable or Disable casxade mode
  * @return None
  */
...
/**
  ...
  * @param  order Event capture order in if both falling and rising are enabled
  * @return None
  */
