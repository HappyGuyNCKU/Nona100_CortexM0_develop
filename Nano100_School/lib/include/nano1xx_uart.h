...
static void UART_DisalbePDMA(UART_TypeDef  *tUART);

void UART_SetFnIRDA(UART_TypeDef  *tUART,STR_IRCR_T *str_IRCR );
 ...
 *
 *  @param[in] u32Port Specify UART_PORT0/UART_PORT1
 *
 *  @par Include:
 *       nano1xx_drivers/nano1xx_uart.h  
 *
