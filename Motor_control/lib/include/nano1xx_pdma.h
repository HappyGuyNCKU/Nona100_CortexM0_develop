...
/**   
  ...
  *         0: The Specified Source Interrupt is disable.
  */
...
/**   
  ...
  *         0: The Source Interrupt Flag is clear.
  */
...
/**   
  ...
  *         u32Sastobl: VDMA Source Address Stride Offset Byte Length (0 ~ 0xffff).
  *         u32Dastobl: VDMA Destination Address Stride Offset Byte Length (0 ~ 0xffff).
  * @retval None.
  */
...
/**   
  ...
  *         u16ByteCount: DMA transfer byte count.
  *         u32SeedValue: CRC seed.
  * @retval None.
  */
...
/**   
  ...
  * @retval read data from Write Data Register.
  */
static __INLINE uint32_t PDMA_CRCGetChecksum()
{
