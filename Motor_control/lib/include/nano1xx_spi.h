...
static __INLINE void SPI_SetByteReorder(SPI_TypeDef *SpiPort, uint8_t bEnable)
{	
	SpiPort->CTL &= ~SPI_CTL_REORDER;
}
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			eSlaveSel: Select the slave select pins which will be used. 
  * @retval None.
  */
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			eSlaveSel: In automatic slave select operation, to use this parameter to select the slave select pins
  *					   which will be used. 
...
/**
  ...
  * @param  SpiPort: SPI port handler  
  *			eSlaveSel: Specify slave select pins.
  *						It could be SPI_NONE, SPI_SS0, SPI_SS1 or SPI_SS0_SS1.
  * @retval None.
  */
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *         u32Pattern: Specify the variable clock pattern
  * @retval None.
  */
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			u8Dir: Set the direction to in/out. (SPI_DUALIO_DIR_IN / SPI_DUALIO_DIR_OUT)
  * @retval None.
  */
static __INLINE void SPI_EnableDualIOMode(SPI_TypeDef *SpiPort, uint8_t bEnable, uint8_t u8Dir)
{
