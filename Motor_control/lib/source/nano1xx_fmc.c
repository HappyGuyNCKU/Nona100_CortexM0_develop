...
/**
  ...
  *         u32data: The 32-bit data to be programmed into flash.
  * @retval E_FMC_OK: Success
  *         E_FMC_ISP_FAIL: ISP command failed.
  */
...
/**
  ...
  * @param  u32addr: Flash word address. Must be a word aligned address.
  *         u32data: A 32-bit buffer to store the word read from flash. 
  * @retval E_FMC_OK: Success
  *         E_FMC_ISP_FAIL: ISP command failed.
  */
...
/**
  ...
  * @retval E_FMC_OK: Success
  *         E_FMC_ISP_FAIL: ISP command failed.
  *         E_FMC_INVALID_ADDR: Invalid mapping address.
  */
...
/**
  ...
  *         u32data: A word buffer to store the unique ID. 
  * @retval E_FMC_OK: Success
  *         E_FMC_ISP_FAIL: ISP command failed.
  *         E_FMC_INVALID_PARAM: Invalid unique ID index.
  */
...
/**
  ...
  *         u32data1: Data word to be written to User Config 1.
  * @retval E_FMC_OK: Success
  *         E_FMC_ISP_FAIL: ISP command failed.
  *         E_FMC_INVALID_PARAM: Invalid unique ID index.
  */
