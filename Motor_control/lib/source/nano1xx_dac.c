...
/**
  ...
  * @param  u8PUPDelay Delay time for DAC to become stable after power up.
...
/**
  ...
  * @param  eLoadSel Trigger source to load data, valid options are DAC_CTL_LSEL_DATA_WRITE, DAC_CTL_LSEL_PDMA,
