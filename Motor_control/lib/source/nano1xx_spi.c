...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			i32BitLength: Specify the bit length (8~32 bits).
  * @retval None.  
  */
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			i32Interval: If the Byte Suspend function is enabled, it specified the delay clocks 
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			pu32Data:  Data got from the SPI bus.
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			pu32Data:  Data will be put to SPI bus.
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			pu32Buf:  Store the data got from Rx registers.
  *			u32DataCount: The count of data read from Rx registers.
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			pu32Buf:  Store the data which will be written to Tx registers.
  *			u32DataCount: The count of data write to Tx registers.
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			bEnable: TRUE/FALSE  -- Enable/Disable DMA
  * @retval None.
  */
...
/**
  ...
  * @param  SpiPort: SPI port handler
  *			bEnable: TRUE/FALSE  -- Enable/Disable SPI wakeup function.
  * @retval None.
  */
